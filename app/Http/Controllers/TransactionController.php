...
class TransactionController extends Controller
{
    public function index(){    
        ...
        return view('transaction.index', compact('products','cart_data','data_total'));
    }
    ...
    public function bayar(){
        ...
        if($kembalian >= 0){  
            ...
            $id = IdGenerator::generate(['table' => 'transactions', 'length' => 10, 'prefix' =>'INV-', 'field' => 'invoices_number']);
    ...
    public function laporan($id){
        $transaction = Transaction::with('productTransaction')->find($id);
        // print_r(json_encode($transaction)); die;
        return view('laporan.transaction',compact('transaction'));
    }
