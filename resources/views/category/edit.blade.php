                            ...
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('category.update', $category->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror"  id="category_name" value="{{ $category->category_name }}"  placeholder="Masukkan Nama Kategori" autofocus>
                                        @error('category_name')
